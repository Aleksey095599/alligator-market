package com.alligator.market.backend.quote.ccypair_feed_settings.mapper;
...
public class CcyPairFeedSettingsMapper {
    ...
    public com.alligator.market.domain.quote.CcyPairFeedSettings toDomain(CcyPairFeedSettingsEntity entity) {
        return new com.alligator.market.domain.quote.CcyPairFeedSettings(
    ...
    public CcyPairFeedSettingsEntity toEntity(
            com.alligator.market.domain.quote.CcyPairFeedSettings cfg,
            PairEntity pair,
            Provider provider) {
