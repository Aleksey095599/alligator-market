package com.alligator.market.backend.quotes.ccypair_feed_settings.repository;
...
public interface CcyPairFeedSettingsRepository extends JpaRepository<CcyPairFeedSettingsEntity, Long> {
    ...
    // Извлекаем записи по заданному провайдеру, активные и PULL (то есть fetchPeriodMs > 0)
    @Query("""
            select s
