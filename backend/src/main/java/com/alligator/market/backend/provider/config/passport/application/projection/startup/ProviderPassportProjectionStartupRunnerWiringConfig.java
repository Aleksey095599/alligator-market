package com.alligator.market.backend.provider.config.passport.application.projection.startup;

import com.alligator.market.backend.provider.config.passport.application.projection.service.ProviderPassportProjectionServiceWiringConfig;
import com.alligator.market.backend.provider.passport.application.projection.ProviderPassportProjectionService;
import com.alligator.market.backend.provider.passport.application.projection.runner.ProviderPassportProjectionStartupRunner;
