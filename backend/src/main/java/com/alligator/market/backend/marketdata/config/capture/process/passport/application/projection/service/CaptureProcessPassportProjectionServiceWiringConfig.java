...
import com.alligator.market.backend.marketdata.config.capture.process.passport.persistence.projection.port.adapter.CaptureProcessPassportProjectionWritePortWiringConfig;
