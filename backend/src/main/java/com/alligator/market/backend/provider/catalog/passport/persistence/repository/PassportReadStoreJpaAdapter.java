...
/**
 * Адаптер доменного {@link ProviderPassportReadStore} (контекст Spring Data JPA).
 *
...
public class PassportReadStoreJpaAdapter implements ProviderPassportReadStore {

    /* JPA-репозиторий. */
    private final PassportJpaRepository jpa;

    /* Конструктор. */
    public PassportReadStoreJpaAdapter(PassportJpaRepository jpa) {
        this.jpa = jpa;
    }
