package com.alligator.market.backend.provider.application.passport.projection.port;
 ...
 * <p>Примечания:</p>
 * <ul>
 *     <li>Рекомендуется выполнять последовательность синхронизации в одной транзакции (транзакционность обеспечивает
 *     вызывающая сторона).</li>
