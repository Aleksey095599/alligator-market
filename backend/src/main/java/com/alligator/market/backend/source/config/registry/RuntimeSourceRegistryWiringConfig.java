...
public class RuntimeSourceRegistryWiringConfig {
    public static final String BEAN_RUNTIME_SOURCE_REGISTRY = "runtimeSourceRegistry";

    @Bean(BEAN_RUNTIME_SOURCE_REGISTRY)
    public RuntimeSourceRegistry runtimeSourceRegistry(List<MarketSource> sources) {
