package com.alligator.market.backend.marketdata.config.capturer.passport.application.query.list;

import com.alligator.market.backend.marketdata.capturer.passport.application.query.list.adapter.JooqMarketDataCapturerPassportListQueryAdapter;
