...
import com.alligator.market.backend.source.adapter.moex.iss.instrument.forex.spot.properties.MoexIssFxSpotHandlerProperties;
...
@EnableConfigurationProperties(MoexIssFxSpotHandlerProperties.class)
public class MoexIssFxSpotHandlerConfig {
    ...
    public MoexIssFxSpotHandler moexIssFxSpotHandler(
            ...
            MoexIssFxSpotHandlerProperties props
    ) {
        return new MoexIssFxSpotHandler(
                webClient,
                new MoexIssFxSpotHandlerPolicy(props.pollInterval())
        );
    }
}
