...
public class InstrumentFeedConfigEntity extends BaseEntity {
     ...
     *
     * <p>Можно обновлять, но это должно быть реализовано в виде отдельной операции, – то есть во фронтенд было бы
     * удобно иметь отдельный переключатель для каждой записи.</p>
     */
