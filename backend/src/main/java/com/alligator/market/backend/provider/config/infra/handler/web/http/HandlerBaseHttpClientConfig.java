package com.alligator.market.backend.provider.config.infra.handler.web.http;

import com.alligator.market.backend.provider.config.infra.handler.web.http.tcp.HandlerBaseConnectionPoolConfig;
