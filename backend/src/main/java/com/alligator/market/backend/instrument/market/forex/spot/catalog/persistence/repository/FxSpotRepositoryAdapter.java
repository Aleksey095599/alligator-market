package com.alligator.market.backend.instrument.market.forex.spot.catalog.persistence.repository;

import com.alligator.market.backend.common.persistence.jpa.constraint.DbErrors;
import com.alligator.market.backend.instrument.market.forex.support.currency.catalog.persistence.jpa.CurrencyEntity;
import com.alligator.market.backend.instrument.market.forex.support.currency.catalog.persistence.jpa.CurrencyJpaRepository;
import com.alligator.market.backend.instrument.market.forex.spot.catalog.persistence.jpa.FxSpotEntity;
import com.alligator.market.backend.instrument.market.forex.spot.catalog.persistence.jpa.FxSpotEntityMapper;
import com.alligator.market.backend.instrument.market.forex.spot.catalog.persistence.jpa.FxSpotJpaRepository;
import com.alligator.market.domain.instrument.market.forex.spot.exception.*;
