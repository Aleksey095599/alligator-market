 ...
 */
@Slf4j
public final class MarketDataCaptureProcessPassportProjectionStartupRunner implements ApplicationRunner {

    private final MarketDataCaptureProcessPassportProjectionService service;

    public MarketDataCaptureProcessPassportProjectionStartupRunner(MarketDataCaptureProcessPassportProjectionService service) {
