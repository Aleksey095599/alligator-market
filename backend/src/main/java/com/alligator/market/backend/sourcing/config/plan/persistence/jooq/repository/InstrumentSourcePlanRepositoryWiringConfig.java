...
import com.alligator.market.backend.sourcing.plan.persistence.jooq.repository.JooqInstrumentSourcePlanRepositoryAdapter;
...
public class InstrumentSourcePlanRepositoryWiringConfig {
    ...
    public InstrumentSourcePlanRepository instrumentSourcePlanRepository(DSLContext dsl) {
        return new JooqInstrumentSourcePlanRepositoryAdapter(dsl);
    }
}
