...
CREATE TABLE provider_profile_instrument_type (
    ...
    CONSTRAINT fk_profile_instrument_type_profile FOREIGN KEY (provider_id)
        REFERENCES provider_profile (id)
);

ALTER TABLE provider_profile_instrument_type
    ADD CONSTRAINT pk_profile_instrument_type PRIMARY KEY (provider_id, instrument_type);
