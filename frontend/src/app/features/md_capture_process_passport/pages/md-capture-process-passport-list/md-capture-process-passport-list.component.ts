...
import { MDCaptureProcessPassportService } from '../../services/md-capture-process-passport.service';

@Component({
  selector: 'app-md-capture-process-passport-list',
  standalone: true,
  imports: [CommonModule, MatTableModule, MatCardModule, MatSnackBarModule],
  templateUrl: './md-capture-process-passport-list.component.html',
  styleUrl: './md-capture-process-passport-list.component.scss'
})
export class MDCaptureProcessPassportListComponent implements OnInit {
  ...
  dataSource = new MatTableDataSource<MDCaptureProcessPassportDto>([]);

  constructor(
    private readonly service: MDCaptureProcessPassportService,
