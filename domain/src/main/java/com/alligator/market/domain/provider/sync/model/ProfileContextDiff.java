...
/**
 * Модель результата сопоставления профилей провайдеров рыночных данных в виде трех списков,
 * касательно которых требуются действия с репозиторием для целей синхронизации.
 */
