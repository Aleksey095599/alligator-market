 ...
 *
 * <p>Причина создания: код валюты применяется часто в разных слоях приложения, следовательно,
 * важно соблюдать единый формат кода; также код валюты регулируется общепринятым стандартом ISO 4217.</p>
 *
