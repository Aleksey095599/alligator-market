package com.alligator.market.domain.instrument.type.forex.currency.code;
...
/**
 * Объект-значение уникального кода валюты формата ISO 4217.
 *
 * <p>Причина создания: код валюты применяется в разных слоях приложения => важно соблюдать единый формат.</p>
 *
