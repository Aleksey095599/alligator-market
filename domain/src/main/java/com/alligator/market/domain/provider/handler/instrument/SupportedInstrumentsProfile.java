...
/**
 * Профиль поддерживаемых инструментов для конфигурации обработчика.
 *
 * <p>Назначение: Фиксирует набор параметров, которым должен соответствовать инструмент, чтобы быть совместимым
 * с обработчиком.</p>
 *
 * @param supportedInstrumentCodes Набор кодов инструментов, поддерживаемых обработчиком
