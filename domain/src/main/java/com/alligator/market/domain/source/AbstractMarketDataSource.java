...
public abstract class AbstractMarketDataSource<P extends MarketDataSource>
    ...
    protected final MarketDataSourceCode sourceCode;
    ...
    @Override
    public MarketDataSourceCode sourceCode() {
        return sourceCode;
    }

    @Override
    public MarketDataSourcePassport passport() {
        return passport;
    }

    @Override
    public MarketDataSourcePolicy policy() {
        return policy;
    }
