 ...
 *
 * <p>Код провайдера применяется в разных слоях приложения и разных классах. Наличие объект-значения
 * позволяет гарантировать единый формат кода провайдера без дублирования однообразных проверок.</p>
 *
