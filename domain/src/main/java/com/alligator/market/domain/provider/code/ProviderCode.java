...
/**
 * Объект-значение уникального кода провайдера рыночных данных.
 *
 * <p>Причина создания: код провайдера применяется в разных слоях приложения => важно соблюдать единый формат.</p>
 *
