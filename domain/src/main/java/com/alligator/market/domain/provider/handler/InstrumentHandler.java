...
/**
 * Доменный контракт обработчика для заданного типа финансовых инструментов, подключенного к заданному провайдеру.
 *
 * <p>Примечание: Обработчик за счёт дженериков параметризован конкретным классом провайдера и классом финансового
 * инструмента, что отражает прикрепление к заданному провайдеру и соответствие заданному типу инструмента.
 * Это является требованием бизнес логики.</p>
 */
